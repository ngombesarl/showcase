...
@Component({
  ...
  template: `
    ...
    <div class="glass p-10 min-h-[50%] flex flex-col items-center text-center rounded-lg text-white">
      <h2 class="text-5xl font-bold mb-4">Des Solutions Complètes pour Tous Vos Besoins</h2>
